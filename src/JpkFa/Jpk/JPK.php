...
class JPK
{
     ...
     * Nagłówek JPK_FA
     *
     * @var \JpkFa\Jpk\JPK\NaglowekAType $naglowek
     */
    private $naglowek = null;

    /**
     * @var \JpkFa\Jpk\JPK\Podmiot1AType $podmiot1
     */
     ...
     *
     * @var \JpkFa\Jpk\JPK\FakturaAType[] $faktura
     */
    private $faktura = [
     ...
     *
     * @var \JpkFa\Jpk\JPK\FakturaCtrlAType $fakturaCtrl
     */
     ...
     *
     * @var \JpkFa\Jpk\JPK\FakturaWierszAType[] $fakturaWiersz
     */
     ...
     *
     * @var \JpkFa\Jpk\JPK\FakturaWierszCtrlAType $fakturaWierszCtrl
     */
     ...
     *
     * @var \JpkFa\Jpk\JPK\ZamowienieAType[] $zamowienie
     */
    private $zamowienie = [
     ...
     *
     * @var \JpkFa\Jpk\JPK\ZamowienieCtrlAType $zamowienieCtrl
     */
     ...
     * Nagłówek JPK_FA
     *
     * @return \JpkFa\Jpk\JPK\NaglowekAType
     */
     ...
     * Nagłówek JPK_FA
     *
     * @param \JpkFa\Jpk\JPK\NaglowekAType $naglowek
     * @return self
     */
    public function setNaglowek(\JpkFa\Jpk\JPK\NaglowekAType $naglowek)
    {
     ...
     * Gets as podmiot1
     *
     * @return \JpkFa\Jpk\JPK\Podmiot1AType
     */
     ...
     * Sets a new podmiot1
     *
     * @param \JpkFa\Jpk\JPK\Podmiot1AType $podmiot1
     * @return self
     */
    public function setPodmiot1(\JpkFa\Jpk\JPK\Podmiot1AType $podmiot1)
    {
     ...
     *
     * @return self
     * @param \JpkFa\Jpk\JPK\FakturaAType $faktura
     */
    public function addToFaktura(\JpkFa\Jpk\JPK\FakturaAType $faktura)
    {
     ...
     * Na podstawie art. 106 a-q ustawy z 11 marca 2004 r. o podatku od towarów i usług (Dz. U. z 2018 r. poz. 2174 z późn. zm.). Wartości sprzedaży i kwoty podatku wypełnia się w walucie, w której wystawiono fakturę, z wyjątkiem pól, w których kwoty podatku zostały przeliczone zgodnie z art. 31a w związku z art. 106e ust. 11 ustawy
     *
     * @return \JpkFa\Jpk\JPK\FakturaAType[]
     */
     ...
     * Sumy kontrolne dla faktur
     *
     * @return \JpkFa\Jpk\JPK\FakturaCtrlAType
     */
     ...
     * Sumy kontrolne dla faktur
     *
     * @param \JpkFa\Jpk\JPK\FakturaCtrlAType $fakturaCtrl
     * @return self
     */
    public function setFakturaCtrl(\JpkFa\Jpk\JPK\FakturaCtrlAType $fakturaCtrl)
    {
     ...
     *
     * @return self
     * @param \JpkFa\Jpk\JPK\FakturaWierszAType $fakturaWiersz
     */
    public function addToFakturaWiersz(\JpkFa\Jpk\JPK\FakturaWierszAType $fakturaWiersz)
    {
     ...
     * Szczegółowe pozycje faktur w walucie, w której wystawiono fakturę
     *
     * @return \JpkFa\Jpk\JPK\FakturaWierszAType[]
     */
     ...
     * Sumy kontrolne dla wierszy faktur
     *
     * @return \JpkFa\Jpk\JPK\FakturaWierszCtrlAType
     */
     ...
     * Sumy kontrolne dla wierszy faktur
     *
     * @param \JpkFa\Jpk\JPK\FakturaWierszCtrlAType $fakturaWierszCtrl
     * @return self
     */
    public function setFakturaWierszCtrl(\JpkFa\Jpk\JPK\FakturaWierszCtrlAType $fakturaWierszCtrl)
    {
     ...
     *
     * @return self
     * @param \JpkFa\Jpk\JPK\ZamowienieAType $zamowienie
     */
    public function addToZamowienie(\JpkFa\Jpk\JPK\ZamowienieAType $zamowienie)
    {
     ...
     * Zamówienia lub umowy, o których mowa w art. 106f ust. 1 pkt 4 ustawy (dla faktur zaliczkowych) w walucie, w której wystawiono fakturę zaliczkową
     *
     * @return \JpkFa\Jpk\JPK\ZamowienieAType[]
     */
     ...
     * Sumy kontrolne dla zamówień lub umów
     *
     * @return \JpkFa\Jpk\JPK\ZamowienieCtrlAType
     */
     ...
     * Sumy kontrolne dla zamówień lub umów
     *
     * @param \JpkFa\Jpk\JPK\ZamowienieCtrlAType $zamowienieCtrl
     * @return self
     */
    public function setZamowienieCtrl(\JpkFa\Jpk\JPK\ZamowienieCtrlAType $zamowienieCtrl)
    {
